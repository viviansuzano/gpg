...
/* Website: https://github.com/ROBOTIS-GIT/turtlebot3_simulations */
...
class GoPiGo3Fake
{
 ...
 private:
  ...
  std::string joint_states_name_[3];

  double camera_position_;
  ...
  void commandCameraCallback(const std_msgs::Float64ConstPtr cmd_msg);
